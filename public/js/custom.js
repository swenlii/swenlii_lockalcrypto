/* ----------------- Start Document ----------------- */
	...
	function starRating(ratingElem) {
		...
		console.log('starRating init')
		$(ratingElem).each(function() {

			var dataRating = $(this).attr('data-rating');

			// Rating Stars Output
			function starsOutput(firstStar, secondStar, thirdStar, fourthStar, fifthStar, sixStar, seventStar, eightStar, nineStar, tenStar) {
				return(''+
					...
					'<span class="'+sixStar+'"></span>'+
					'<span class="'+seventStar+'"></span>'+
					'<span class="'+eightStar+'"></span>'+
					'<span class="'+nineStar+'"></span>'+
					'<span class="'+tenStar+'"></span>');
			}
			...
			} else if (dataRating >= 9) {
				$(this).append(nineStars);
			} else if (dataRating >= 8) {
				$(this).append(eightStars);
			} else if (dataRating >= 7) {
				$(this).append(sevenStars);
			} else if (dataRating >= 6) {
				$(this).append(sixStars);
			} else if (dataRating >= 5) {
				$(this).append(fiveStars);
			} else if (dataRating >= 4) {
...
$(document).ready(function(){
	...
	function wrapperHeight() {
		...
		$('.full-page-content-container, .dashboard-sidebar-inner, .dashboard-container, .full-page-container').css({ height: windowHeight });
